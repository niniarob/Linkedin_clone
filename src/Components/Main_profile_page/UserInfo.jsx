        ...
        <div className="userInfoBackground">
          <div className="userInfo">
            ...
            <div className="userPhotoNameProfetion">
              <img
                className="userPohoProfilePage"
                src={user.photoURL}
                alt="./Ellipse 15.png"
              />
              <h2 className="userInfoName">{user.displayName}</h2>
              <p className="userInfoProfetion">
                Bachelor International Relations and Law
              </p>
            </div>
            <div className="contactInfoPart">
              <p className="serviceParagraph">
                ANZ OILFIELD SERVICES PVT. LTD.
              </p>
            ...
            <div className=" linkButtons">
              <div className="butto">
                <p className="openTo">Open to</p>
              </div>
              <div className="butto">
                <p className="openTo">Add profile section</p>
              </div>
              <div className="butto grayBorder">
                <p className="openTo more">More</p>
              </div>
            </div>
          </div>
        </div>
